    ...
    public class TareasContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            /*En el primer dato semilla CategoriaID:
              ...
              se generaran los codigos Guid utilizando alguna de las paginas que existen para generar este tipo de codigos.
              */
            ...
            List<Tarea> tareasIniciales = new List<Tarea>(); //Lista creada para enunciar los Datos Semilla y los campos que los requieran 
            tareasIniciales.Add(new Tarea() { TareaId = Guid.Parse("907f7cf7-7d85-4d28-9ad0-7c6eb71235eb"), CategoriaId = Guid.Parse("907f7cf7-7d85-4c28-9ad0-7c6eb70235eb"), Titulo = "Tareas Pendientes", PrioridadTarea = Prioridad.Alta, FechaCreacion = DateTime.Now, Descripcion = "Esta es una descripcion"});
            tareasIniciales.Add(new Tarea() { TareaId = Guid.Parse("907f7cf7-8d85-4c29-9ad0-7c6eb70236eb"), CategoriaId = Guid.Parse("907f7cf7-7d85-4c28-9ad0-7c6eb70236eb"), Titulo = "Tareas Personales", PrioridadTarea = Prioridad.Baja, FechaCreacion = DateTime.Now, Descripcion = "Esta es una descripcion"});
